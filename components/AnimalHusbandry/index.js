...
const AnimalHusbandry = ({ category = "animal-husbandry", subCategory = "", tag = "" }) => {
    const ClickHandler = () => {
                                                    ...
                                                    <div className="entry-details">
                                                        <h3 style={{
                                                            ...
                                                            <Link 
                                                                ...
                                                                href={`/blog/animal-husbandry/${blog.slug}`} 
                                                                as={`/blog/animal-husbandry/${blog.slug}`} 
