...
const CropInfo = ({ category = "crop-information", subCategory = "", tag = "" }) => {
    const ClickHandler = () => {
                                                    ...
                                                    <div className="entry-details">
                                                        <h3 style={{
                                                            ...
                                                            <Link 
                                                                ...
                                                                href={`/blog/crop-information/${blog.slug}`} 
                                                                as={`/blog/crop-information/${blog.slug}`} 
