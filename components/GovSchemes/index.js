...
const GovSchemes = ({ category = "agricultural-schemes", subCategory = "", tag = "" }) => {
    const ClickHandler = () => {
        ...
        <section className="wpo-blog-pg-section" style={{ paddingTop: "20px", backgroundColor: "#f9f9f9" }}>
            <div className="container">
                <div className="row">
                                                    ...
                                                    <div className="entry-details">
                                                        <h3 style={{
                                                            ...
                                                            <Link 
                                                                ...
                                                                href={`/blog/agricultural-schemes/${blog.slug}`} 
                                                                as={`/blog/agricultural-schemes/${blog.slug}`} 
                    ...
                    <Link 
                        href="/blogs/agricultural-schemes" 
